...
const styles = {
  ...
  sectionTitle:
    "text-3xl sm:text-4xl font-bold text-gray-800 tracking-tight text-center mb-6",
  sectionSubtitle: "text-lg text-gray-600 text-center max-w-3xl mx-auto mb-12",
  card: "bg-white rounded-xl p-8 shadow-lg",
  button: {
    primary:
      "bg-[#00AFCA] hover:bg-[#008CBA] text-white font-semibold py-3 px-8 rounded-lg transition duration-300",
    secondary:
      "bg-gray-600 hover:bg-gray-700 text-white font-semibold py-3 px-8 rounded-lg transition duration-300",
    outline:
      "border border-gray-400 hover:bg-gray-100 text-gray-700 font-semibold py-3 px-8 rounded-lg transition duration-300",
  },
};
...
const pricingData = [
  {
    feature: "Quản lý cluster production high-availability",
    vcloud: "MIỄN PHÍ**",
    compA: "945.000 VNĐ",
    compB: "1.720.000 VNĐ",
    compC: "1.720.000 VNĐ",
  ...
  {
    feature: "Lưu lượng Egress",
    vcloud: "MIỄN PHÍ**",
    compA: "225 VNĐ / GiB",
    compB: "1.175 VNĐ – 2.125 VNĐ / GiB",
    compC: "1.650 VNĐ – 1.875 VNĐ / GiB",
    compD: "1.650 VNĐ – 1.875 VNĐ / GiB",
  },
  // ... more pricing data
];
...
const faqData = [
  {
    ...
    answer:
      "Đây là một dịch vụ quản lý hoàn toàn vòng đời của các Kubernetes cluster, bao gồm cài đặt, cập nhật, mở rộng và bảo trì master nodes (control plane). Điều này cho phép bạn tập trung vào việc triển khai ứng dụng thay vì quản lý hạ tầng Kubernetes phức tạp.",
  },
  // ... more FAQ items
];
...
const benefits = [
  {
    ...
    description:
      "Cấp phát worker nodes chỉ bằng một cú nhấp chuột qua portal, API, hoặc Terraform.",
  },
  {
    icon: CurrencyDollarIcon,
    title: "Hỗ trợ GPU worker nodes",
    description:
      "Chạy các workload nặng về GPU như machine learning, xử lý video, và gaming.",
  },
  {
    icon: CurrencyDollarIcon,
    title: "Phiên bản mới nhất",
    description:
      "Hỗ trợ ít nhất bốn phiên bản Kubernetes mới nhất, đảm bảo tính tương thích và bảo mật.",
  },
  {
    icon: CurrencyDollarIcon,
    title: "Kiểm soát tự động",
    description:
      "Liên tục giám sát, cập nhật và khởi động lại node tự động nếu cần thiết.",
  },
  {
    icon: CurrencyDollarIcon,
    title: "Mở rộng tự động",
    description:
      "Số lượng node trong pool có thể tự động tăng hoặc giảm theo nhu cầu.",
  },
  {
    icon: CheckCircleIcon,
    title: "Tính sẵn sàng cao",
    description:
      "Mỗi cluster dashboard được nhân bản để đảm bảo cluster luôn sẵn sàng.",
  },
  {
    icon: LockClosedIcon,
    title: "Kết nối an toàn",
    description:
      "Tất cả kết nối giữa master node và các node trong cluster đều được mã hóa tự động.",
  },
  {
    icon: ShieldExclamationIcon,
    title: "Bảo vệ DDoS",
    description:
      "Dự án của bạn được bảo vệ khỏi các cuộc tấn công DDoS ở lớp mạng và transport theo mặc định.",
  },
  {
    icon: PhoneIcon,
    title: "Hỗ trợ kỹ thuật 24/7",
    description:
      "Hỗ trợ thời gian thực nhanh chóng và dịch vụ kỹ thuật chất lượng suốt ngày đêm.",
  },
];
        ...
        <div className={styles.container}>
          <div className="text-center">
            ...
            <p className="text-lg md:text-xl lg:text-2xl max-w-3xl mx-auto mb-8">
              Giải pháp Kubernetes mạnh mẽ, linh hoạt và tiết kiệm chi phí để
        ...
        <div className={styles.container}>
          <div className="text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Thử giải pháp của chúng tôi để xây dựng Managed Kubernetes VCLOUD
              tối ưu
            </h2>
            <button className="bg-white text-[#00AFCA] font-semibold py-3 px-8 rounded-lg text-lg transition duration-300 hover:bg-gray-100">
              Chạy Cluster
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className={styles.card}>
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-4">
                  Dịch vụ serverless computing để chạy mã trong môi trường sẵn
                  sàng.
                </p>
                <a
                  href="#"
                  className="text-[#00AFCA] hover:text-[#008CBA] font-semibold"
                >
                  Tìm hiểu thêm &rarr;
                </a>
              </div>
            ...
            <div className={styles.card}>
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-4">
                  Thu thập log từ tất cả các máy chủ của bạn vào một kho lưu trữ
                  duy nhất.
                </p>
                <a
                  href="#"
