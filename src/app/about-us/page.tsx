...
const AboutUsPage = () => {
  return (
    <div className="bg-slate-50">
      {/* Hero Section */}
      <section className="bg-navy-gradient py-20 md:py-32 hero-overlay">
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-sky-100 to-lime-100">
        <div className="container mx-auto px-6 text-center">
          ...
          <button className="bg-gradient-to-r from-cyan-400 to-green-400 text-white font-semibold py-3 px-8 rounded-lg text-lg hover:shadow-lg transition duration-300">
            Liên Hệ Ngay
          </button>
        </div>
      </section>
