...
export default function ContactPage() {
  ...
  const [loadMethod, setLoadMethod] = useState<"iframe" | "script" | "direct">(
    "iframe"
  );
            ...
            <div className="lg:col-span-2 space-y-8">
              <div>
                ...
                <p className="text-lg text-gray-600 leading-relaxed mb-8">
                  Dù bạn đang lên kế hoạch nâng cấp hạ tầng hay khởi động dự án
                  mới, chúng tôi luôn sẵn sàng giúp bạn tối ưu hóa chiến lược,
                  thiết kế và hiệu suất cloud. Liên hệ ngay để được tư vấn miễn
                  phí. Không áp lực, chỉ là cuộc trò chuyện chuyên sâu và tập
                  trung.
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-8 rounded-2xl border-l-4 border-blue-600">
                ...
                <blockquote className="text-gray-900 mb-6 leading-relaxed">
                  "Họ là đối tác hoàn hảo cho loại hình phát triển hạ tầng cloud
                  và thiết kế giải pháp mà doanh nghiệp của chúng tôi cần.
                  VCLOUD đã giúp chúng tôi tối ưu hóa toàn bộ hệ thống và nâng
                ...
                <div>
                  ...
                  <div className="text-gray-600">
                    Giám đốc IT, Tập đoàn ABC Technology
                  </div>
                </div>
              </div>
            </div>
                          ...
                          <div className="text-center max-w-lg mx-auto">
                            <div className="mb-8">
                              ...
                              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                                Đặt cuộc gọi tư vấn miễn phí
                              </h3>
                              <p className="text-gray-600 mb-8">
                                Cuộc gọi 30 phút để thảo luận về nhu cầu cloud
                                infrastructure của bạn
                              </p>
                            </div>
                            ...
                            <p className="text-sm text-gray-500 mb-8">
                              Cuộc gọi để làm quen và kiểm tra xem chúng tôi có
                              phù hợp với nhu cầu của bạn và doanh nghiệp của
                              bạn không.
                            </p>
                            ...
                            <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                              <p className="text-sm text-green-700">
                                ✅ Phương thức này luôn hoạt động! Click "Chọn
                                thời gian phù hợp" để đặt lịch ngay.
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="calendly-fallback p-8 h-full flex items-center justify-center">
                          <div className="fallback-content text-center max-w-lg mx-auto">
                            <div className="mb-8">
                              ...
                              <p className="text-gray-600 mb-8">
                                Xin lỗi, có lỗi kỹ thuật với widget. Vui lòng sử
                                dụng link trực tiếp để đặt lịch.
                              </p>
                            </div>
